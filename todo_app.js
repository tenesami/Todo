let todos = [
    ...
    { date: "2026-06-08", task: "ርክክብ", assigned_to: "ሰበካ ጉባኤ", status: "done" },
    { date: "2026-06-09", task: "በዓል ኮሚቴ መጥራት", assigned_to: "ሰበካ ጉባኤ", status: "Done" },
    { date: "2026-06-10", task: "ቅዲስ ሚካኤል ጽዋ ማህበር ሙሴ መጥራት", assigned_to: "ሰበካ ጉባኤ", status: "Done" }
